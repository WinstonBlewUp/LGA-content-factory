...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    document.getElementById('trigger-loader').addEventListener('click', function() {
        isLoading = true;
        startLoader(); 
    });
    ...
    function animateLoading() {
        ...
        if (isLoading === true && upward_moving_group.currentY > -710) {
...
// function easeInOut(t) {
//     var period = 300; // Ajustement de la période pour lisser l'animation
//     return (Math.sin(t / period + 100) + 1) / 2;
// }
...
//         isLoading = true;
//         startLoader(); 
//         animateLoading();  // Lancer l'animation seulement après le clic sur le bouton
//     });
...
//         // Ralentir le défilement pour plus de fluidité
//         upward_moving_group.currentY -= 2 * easeInOut(now); // Moins rapide que le 8 précédent

//         // Gestion des checks (cercles) lors du défilement
//         checks.forEach(function (check, i) {
//             var color_change_boundary = -i * verticalSpacing + verticalSpacing + 15;
//             if (upward_moving_group.currentY < color_change_boundary) {
//                 var alpha = Math.max(
//                     Math.min(
//                         1 - (upward_moving_group.currentY - color_change_boundary + 15) / 30,
//                         1
//                     ),
//                     0
//                 );
...
//         // Réinitialisation fluide de la position pour continuer à boucler
//         if (upward_moving_group.currentY < -710) {
//             upward_moving_group.currentY = upward_moving_group.currentY % 710; // Ajustement fluide pour éviter l'arrêt brusque
//         }

//         // Continue l'animation tant que isLoading est true
//         if (isLoading === true) {
//             requestAnimationFrame(animateLoading);
//         }
//     }
